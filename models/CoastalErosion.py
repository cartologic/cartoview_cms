...
class CoastalErosion(BaseGeoPage):
    is_creatable = True
    subpage_types = []
    ...
    category_identifier = "coastalErosion"
    category_description = "Base Category for all CMS Coastal Erosion Topics"
    category_gn_description = "Coastal Erosion"

    def __init__(self, *args, **kwargs):
        super(CoastalErosion, self).__init__(*args, **kwargs)
        BaseGeoPage.assure_category_exists(CoastalErosion.category_identifier, CoastalErosion.category_description,
                                           CoastalErosion.category_gn_description)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.app_instance is None:
            ...
            app_instance.save()
        super(CoastalErosion, self).save()
