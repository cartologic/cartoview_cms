...
class SeaWaterIntrusion(BaseGeoPage):
    is_creatable = True
    subpage_types = []
    ...
    category_identifier = "seaWaterIntrusion"
    category_description = "Base Category for all CMS Sea Water Intrusion Topics"
    category_gn_description = "Sea Water Intrusion"

    def __init__(self, *args, **kwargs):
        super(SeaWaterIntrusion, self).__init__(*args, **kwargs)
        BaseGeoPage.assure_category_exists(SeaWaterIntrusion.category_identifier, SeaWaterIntrusion.category_description,
                                           SeaWaterIntrusion.category_gn_description)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.app_instance is None:
            ...
            app_instance.save()
        super(SeaWaterIntrusion, self).save()
