...
class LandSubsidence(BaseGeoPage):
    is_creatable = True
    subpage_types = []
    ...
    category_identifier = "landSubsidence"
    category_description = "Base Category for all CMS Land Subsidence Topics"
    category_gn_description = "Land Subsidence"

    def __init__(self, *args, **kwargs):
        super(LandSubsidence, self).__init__(*args, **kwargs)
        BaseGeoPage.assure_category_exists(LandSubsidence.category_identifier, LandSubsidence.category_description,
                                           LandSubsidence.category_gn_description)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.app_instance is None:
            ...
            app_instance.save()
        super(LandSubsidence, self).save()
